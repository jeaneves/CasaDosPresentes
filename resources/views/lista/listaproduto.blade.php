	...
	@if($produto)
		...
		<br><br><br><br><br>
			<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
				<a href="{{ route('listas.index') }}" class="stext-109 cl8 hov-cl1 trans-04">
					listas
		...
		<section class="sec-product-detail bg0 p-t-65 p-b-60">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<span class="mtext-106 cl2">
								R$ <?php echo number_format( $produto->preco_vend, 2,',','.'); ?>
							</span>
				...
				<div class="bor10 m-t-50 p-t-43 p-b-40">
					...
					<div class="tab01">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li class="nav-item p-b-10">
								<a class="nav-link" data-toggle="tab" href="#informacao" role="tab">Informação Adicional</a>
							</li>
			...
			<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
				<span class="stext-107 cl6 p-lr-25">
					SKU: {{$produto->cod_prod}}
				</span>

				<span class="stext-107 cl6 p-lr-25">
					Categorias: {{$produto->cod_marca}}
				</span>
			</div>
		</section>
		<!-- Related Products -->
		<section class="sec-relate-product bg0 p-t-45 p-b-105">
			<div class="container">
				...
				<div class="wrap-slick2">
					<div class="slick2">
						@foreach($produrelacionado as $prodrel)	
							<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
								<div class="block2">
									<div class="block2-pic hov-img0">
										<img src="{{asset('images/product-01.jpg')}}" alt="IMG-PRODUCT">
										<a href="{{ route('listas.produto',$prodrel->id) }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
										Ver Produto
										</a>
									</div>
